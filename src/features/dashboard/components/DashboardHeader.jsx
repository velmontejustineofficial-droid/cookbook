...
export default function DashboardHeader({ searchTerm, onSearchChange }) {
  return (
    <header className="flex items-center gap-3 border-b border-[#e7dfd0] bg-[#fffaf0] px-4 py-3">
      ...
      <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#e7bd4f] text-sm font-bold text-[#294c39] shadow-sm">JD</div>
    </header>
  )
}