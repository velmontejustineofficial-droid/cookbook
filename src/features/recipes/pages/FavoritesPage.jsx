  ...
  return (
    <div className="w-full rounded-[28px] border border-[#eadfcd] bg-[#fffaf1] p-4 shadow-sm">
      ...
      {favorites.length > 0 ? <>
        ...
        <div className="mt-5"><RecipeList recipes={filteredFavorites} onToggleFavorite={toggleFavorite} currentUserId={currentUserId} onEdit={onEdit} onDelete={deleteRecipe} /></div>
