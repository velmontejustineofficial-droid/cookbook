...
export default function MyRecipesPage({ currentUserId, onBack }) {
  ...
  return (
    <div className="w-full rounded-[28px] border border-[#eadfcd] bg-[#fffaf1] p-4 shadow-sm">
      ...
      <div className="mt-5"><RecipeList recipes={filteredRecipes} onToggleFavorite={toggleFavorite} currentUserId={currentUserId} onEdit={setEditingRecipeId} onDelete={deleteRecipe} onView={setViewingRecipe} /></div>
